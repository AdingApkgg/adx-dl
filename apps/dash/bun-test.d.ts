// Minimal local typings for `bun:test`. Copied from apps/web/bun-test.d.ts —
// same reason applies here: `@types/bun`'s global declarations clash with the
// DOM lib this app needs for its React client. If a third workspace ever needs
// these, extract them into a shared packages/ entry rather than copying again.
